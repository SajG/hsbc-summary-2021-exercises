...
public class EmployeeDaoJdbcImpl implements EmployeeDao{
	...
	public void save(Employee employee) {
		try {
			...
			String insertQuery = "insert into employee_db (name, id, salary) values(?,?,?)";
	...
	public Employee fetchEmployeeById(int id) {
		...
		try {
			Connection connection = DBConnection.establishConnection();
			String selectQuery = "select * from employee_db where id = ?";
	...
	public Employee[] findAllEmployees() {
		...
		try {
			Connection connection = DBConnection.establishConnection();
			String selectQuery = "select * from employee_db";
			PreparedStatement statement = connection.prepareStatement(selectQuery);
			ResultSet result = statement.executeQuery();
	...
	public void updateEmployee(int id, Employee employee) {
		...
		try {
			Connection connection = DBConnection.establishConnection();
			String updateQuery="update employee_db set name=?,salary=? where id=?";
