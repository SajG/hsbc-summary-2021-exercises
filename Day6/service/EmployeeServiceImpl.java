...
public class EmployeeServiceImpl implements EmployeeService {
	/*
	 * private EmployeeDao dao = null; public EmployeeServiceImpl() { // this is
	 * wrong approach we need to use factory pattern dao = new
	 * EmployeeDaoArrayImpl(); }
	 */
	
	EmployeeDao dao=FactoryPattern.getDaoInstance();
	EmployeeDao dao1=FactoryPattern.getDaoListInstance();
	EmployeeDao dao2=FactoryPattern.getDaoSetInstance();
	@Override
